...
public class ReciboRowMapper implements RowMapper<ReciboDAO> {
     ...
     */
    @Override
    public ReciboDAO mapRow(ResultSet rs, int rowNum) throws SQLException {
        ReciboDAO resultado= new ReciboDAO();
        resultado.setNumerorecibo(rs.getString("numeroRecibo"));
